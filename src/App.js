...
function App() {
  ...
  const loadBlockchainData = async () => {
    ...
    for (var i = 1; i <= totalSupply; i++) {
      ...
      const homeMetadata = metadata[i - 1]
      homeMetadata.image = responseMetadata.image
      homes.push(homeMetadata)
    }
            ...
            <div className='card' key={index} onClick={() => togglePop(home)}>
              ...
              <div className='card__info'>
                ...
                <p>
                  ...
                  <strong>{home.attributes[4].value}</strong> sm2
                </p>
                <p>{home.address}</p>
              </div>
            </div>
